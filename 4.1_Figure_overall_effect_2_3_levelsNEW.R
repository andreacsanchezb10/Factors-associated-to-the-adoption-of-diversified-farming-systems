...
figure3_distribution<-ggplot(
  ...
  scale_x_continuous(
    ...
    breaks = c(0,25,50,75,100,125,150,175),
    labels= c("0","25","50","75","100","125","150","175"))
farmers_behaviour_distribution

farmers_behaviour.plot<-ggarrange(farmers_behaviour,farmers_behaviour_distribution,ncol = 2,widths = c(1, 0.25))
farmers_behaviour.plot

figure2.plot<-ggarrange(knowledge_access.plot,farmers_behaviour.plot,ncol = 1,nrow = 2,heights = c(1, 2), )
figure2.plot
