...
aicc$moderator[aicc$moderator %in% c("m_model_method")] <- "Model type"
...
aicc$moderator[aicc$moderator %in% c("n_predictors_num")] <- "Number of\npredictors"
aicc$moderator[aicc$moderator %in% c("m_region")] <- "Region"
aicc$moderator[aicc$moderator %in% c("m_sub_region")] <- "Sub-region"
sort(unique(aicc$pcc_factor_unit))       
